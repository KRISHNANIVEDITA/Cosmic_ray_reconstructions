...
T1P5 = uproot.open("/users/PAS1968/knivedita/saturation_root/3s.root")
tree_t1p5 = T1P5["tree"]
...
lowcount = 0
highcount=0
with open('/users/PAS1968/knivedita/data_analysis/3s_1.1.csv', 'w', newline='') as f:
    writer = csv.writer(f)
    ...
    counter=0
    ### event 71 , 100
    for sec, nsec in zip(utc_secs10[:50], utc_nsecs10[:50]):
